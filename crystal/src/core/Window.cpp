...
namespace crystal
{
    Window::Window (const char*           name,
        ...
        : m_window_name (name), m_frame_buffer_size (size), m_background_color (background_color),
          m_renderer (renderer), m_renderer_attached_b (false), m_window_destroyed_b (false),
    ...
    {
        m_glfw_window =
            glfwCreateWindow (m_frame_buffer_size.width, m_frame_buffer_size.height, m_window_name.data (), NULL, NULL);
