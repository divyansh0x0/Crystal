#include "krystal/geometry/Matrix.hpp"
#include <limits>
...
namespace ktl::geometry
{
    ...
    Matrix Matrix::operator* (const Matrix& other) const
    {
        ...
        {
            // throw std::runtime_error("Invalid matrix dimensions, cannot multiply matrices of dimensions " +
            // std::to_string(num_rows) + "x"
            //                          + std::to_string(num_cols) + " and " + std::to_string(other.num_rows) + "x" +
    ...
    {
        return matrix * scalar; // Reuse the member operator*
    }
} // namespace ktl::geometry
