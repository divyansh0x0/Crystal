...
SRC_FILES := $(wildcard ${SOURCE_DIRECTORY}/*.cpp) $(wildcard ${SOURCE_DIRECTORY}/geometry/*.cpp) $(wildcard ${SOURCE_DIRECTORY}/core/*.cpp) $(wildcard ${SOURCE_DIRECTORY}/graphics/*.cpp)  $(wildcard ${SOURCE_DIRECTORY}/layout/*.cpp) 
